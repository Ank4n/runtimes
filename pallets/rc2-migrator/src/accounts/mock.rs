...
//! Mock relay-chain runtime for the accounts stage: the real deposit-owning pallets, so every
//! expected reserve in the tests is placed the way mainnet placed it.

use crate as pallet_rc2_migrator;
use codec::{Decode, DecodeWithMemTracking, Encode, MaxEncodedLen};
use frame_support::{
	derive_impl, parameter_types,
	traits::{ConstU128, Currency, InstanceFilter, ReservableCurrency},
};
